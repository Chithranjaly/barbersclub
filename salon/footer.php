			...
			<div class="row">
				...
				<div class="col-xl-2 col-sm-6 mb-4 mb-xl-0 single-footer-widget">
					...
					<ul>
						...
						<li>8:00 AM to 7:00 PM</li>
						<li>Sunday holiday</li>
						<li>Home service available all days</li>
					</ul>
				</div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This website is made by &nbsp <i class="fa fa-heart" aria-hidden="true"></i> by Chithranjaly K S
