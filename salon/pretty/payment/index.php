						...
						<div class="sap_tabs">
							<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
								...
								<div class="resp-tabs-container">
										...
										<div class="payment-info">
												...
												<div class="tab-for">				
													...
													<h5>FIRST NAME</h5>													
														<input type="text"  value="">
															<h5>AMOUNT</h5>	
														<input type="text" name="amount" value="<?php echo "Rs.". $amount; ?>">
												</div>			
											</form>
											...
											<form action="#" method="POST">
												<div class="tab-for">				
													...
													<h5>CARD NUMBER</h5>													
														<input class="pay-logo" type="text" required="" value="0000-0000-0000-0000" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '0000-0000-0000-0000';}" >
												</div>	
													...
													<div class="tab-form-left user-form">
														<h5>EXPIRATION</h5>
															<ul>
																...
																<li>
																	<input type="number"  class="text_box" type="text" value="2030" min="1" />	
																</li>
									...
									{
										$sql="update appoinment set payment_status='paid' where id=$id";
										$run=mysqli_query($con,$sql);
										  echo '<meta http-equiv="refresh" content="0;../paysuccess.php">';
									}
									?>
